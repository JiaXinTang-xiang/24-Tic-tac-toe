...
# 棋子放置区: 取棋脉冲坐标, 匹配 STM32 ChessputB(黑,左) / ChessputW(白,右)
# 黑棋左侧, 白棋右侧, 按 Y 递增排列
BLACK_PIECES = [(188, 440), (188, 600), (188, 760), (188, 920), (188, 1080)]
WHITE_PIECES = [(2050, 440), (2050, 600), (2050, 760), (2050, 920), (2050, 1080)]
